...
class ReviewManagerTest extends WP_UnitTestCase
{
    ...
    public function test_create_with_empty_name_and_email()
    {
        $request = [
            'name' => '',
            'email' => '',
        ...
        $this->assertTrue($review->isValid());
        $this->assertEquals($review->author_id, $user1->ID);
        $this->assertEquals($review->email, $user1->user_email);
        $this->assertEquals($review->author, 'testuser1');
        ...
        $review = $this->createReview($request);
        $this->assertTrue($review->isValid());
        $this->assertEquals($review->author_id, $user2->ID);
        $this->assertEquals($review->email, $user2->user_email);
        $this->assertEquals($review->author, 'xx2');
        // User 3 - use display_name
        $user3 = self::factory()->user->create_and_get([
        ...
        $review = $this->createReview($request);
        $this->assertTrue($review->isValid());
        $this->assertEquals($review->author_id, $user3->ID);
        $this->assertEquals($review->email, $user3->user_email);
        $this->assertEquals($review->author, 'xx3');
        // User 4 - don't expose email
        $user4 = self::factory()->user->create_and_get([
        ...
        $review = $this->createReview($request);
        $this->assertTrue($review->isValid());
        $this->assertEquals($review->author_id, $user4->ID);
        $this->assertEquals($review->email, $user4->user_email);
        $this->assertEquals($review->author, 'testuser4');
    }
