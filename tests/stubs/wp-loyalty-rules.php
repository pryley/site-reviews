...
/**
 * wp-loyalty-rules 1.4.6 + 1.4.6
 * Generated by tests/bin/generate-stubs.php — do not edit, rerun `make stubs:update`.
 * Source: https://downloads.wordpress.org/plugin/wployalty.latest-stable.zip (1.4.6)
 * Source: tests/bin/zips/wp-loyalty-rules.zip (1.4.6)
 */
