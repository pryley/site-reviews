...
namespace {
    ...
    abstract class WC_Abstract_Order extends \WC_Abstract_Legacy_Order
    {
        ...
        */
         ...
         * @var array
         */
        protected array $item_types_to_group = array('line_item' => 'line_items', 'tax' => 'tax_lines', 'shipping' => 'shipping_lines', 'fee' => 'fee_lines', 'coupon' => 'coupon_lines');
        /**
        ...
        */
         ...
         * @return string
         */
        public function get_cogs_total_value_html(?array $wc_price_arg = \null): string
        {
        }
    }
    /**
...
namespace {
    ...
    class WC_Emails
    {
         ...
         *
         * @since 10.8.0
         * @var \Automattic\WooCommerce\Internal\Email\DeferredEmailQueue|null
         */
        protected static $deferred_queue = \null;
        /**
         ...
         *
         * @param WC_Order    $order         Order instance.
         * @param \Automattic\WooCommerce\Admin\Features\Fulfillments\Fulfillment $fulfillment Fulfillment instance.
         * @param bool        $sent_to_admin If should sent to admin.
         * @param bool        $plain_text    If is plain text email.
         * @param string      $email         Email address.
         * @return void
    ...
    class WC_Order_Item extends \WC_Data implements \ArrayAccess
    {
        ...
        */
         ...
         * @return string
         */
        public function get_cogs_refund_value_html(float $refunded_cost, ?array $wc_price_arg = \null, ?\WC_Order $order = \null): string
        {
        }
        /**
    ...
    class WC_Query
    {
         ...
         * @return array
         */
        public function stock_status_meta_query($status = \Automattic\WooCommerce\Enums\ProductStockStatus::IN_STOCK)
        {
        }
        /**
         * Layered nav init.
    ...
    class WC_Email extends \WC_Settings_API
    {
         ...
         *
         * @var \Automattic\WooCommerce\Internal\EmailEditor\TransactionalEmailPersonalizer
         */
        public $personalizer;
        /**
