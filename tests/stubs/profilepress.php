...
namespace {
    ...
    class WP_User_Avatar_Shortcode
    {
         ...
         * @return string
         */
        public function wpua_shortcode($atts, $content = \null)
        {
        }
        /**
         * Update user
...
namespace ProfilePress\Core\Admin\SettingsPages {
    abstract class AbstractSettingsPage
    {
         ...
         *
         * @param \ProfilePress\Custom_Settings_Page_Api $instance
...
namespace ProfilePress\Core\Admin\SettingsPages\DragDropBuilder {
    class DragDropBuilder
    {
        ...
        /** @var \ProfilePress\Core\Themes\DragDrop\AbstractTheme */
...
namespace ProfilePress\Core\Admin\SettingsPages\DragDropBuilder {
    class Metabox
    {
        ...
        /**
         * @param array $args
         * @param \ProfilePress\Core\Themes\DragDrop\AbstractTheme $theme_class_instance
...
namespace ProfilePress\Core\Admin\SettingsPages {
    ...
    class FuseWP
    {
        ...
        private $config = array('lite_plugin' => 'fusewp/fusewp.php', 'lite_download_url' => 'https://downloads.wordpress.org/plugin/fusewp.latest-stable.zip', 'fusewp_settings' => 'admin.php?page=fusewp-sync');
    ...
    class MailOptin
    {
        ...
        private $config = array('lite_plugin' => 'mailoptin/mailoptin.php', 'lite_download_url' => 'https://downloads.wordpress.org/plugin/mailoptin.latest-stable.zip', 'mailoptin_settings' => 'admin.php?page=mailoptin-optin-campaigns');
        private $output_data = array();
        public function __construct()
        {
        }
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\CouponsPage {
    class CouponWPListTable extends \WP_List_Table
    {
         ...
         * Render the bulk edit checkbox
         *
         * @param \ProfilePress\Core\Membership\Models\Coupon\CouponEntity $item
         *
         * @return string
         */
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\CustomersPage {
    class CustomerWPListTable extends \WP_List_Table
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Customer\CustomerEntity $customer
         *
         * @return string
         */
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\DashboardPage {
    abstract class AbstractReport
    {
        ...
        /**
         * @param bool $groupBy
         * @param \ProfilePressVendor\Carbon\Carbon $start_date
         * @param \ProfilePressVendor\Carbon\Carbon $end_date
         *
         * @return string|void
         */
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\GroupsPage {
    class GroupWPListTable extends \WP_List_Table
    {
         ...
         * Render the bulk edit checkbox
         *
         * @param \ProfilePress\Core\Membership\Models\Group\GroupEntity $item
         *
         * @return string
         */
        public function column_cb($item)
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\OrdersPage {
    class OrderWPListTable extends \WP_List_Table
    {
         ...
         * Render the bulk edit checkbox
         *
         * @param \ProfilePress\Core\Membership\Models\Order\OrderEntity $order
         *
         * @return string
         */
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\PlansPage {
    class PlanWPListTable extends \WP_List_Table
    {
         ...
         * Render the bulk edit checkbox
         *
         * @param \ProfilePress\Core\Membership\Models\Plan\PlanEntity $item
         *
         * @return string
         */
        public function column_cb($item)
...
namespace ProfilePress\Core\Admin\SettingsPages\Membership\SubscriptionsPage {
    ...
    class SubscriptionWPListTable extends \WP_List_Table
    {
         ...
         * Render the bulk edit checkbox
         *
         * @param \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $subscription
         *
         * @return string
         */
         ...
         *
         * @param \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $subscription The subscription entity.
...
namespace ProfilePress\Core\Classes {
    ...
    class FormRepository
    {
         ...
         * @param $form_type
         *
         * @return \ProfilePress\Core\Themes\DragDrop\AbstractTheme|bool
         */
...
namespace ProfilePress\Core\Classes {
    ...
    class ShortcodeThemeFactory
    {
         ...
         *
         * @return bool|\ProfilePress\Core\Themes\Shortcode\ThemeInterface|\ProfilePress\Core\Themes\Shortcode\PasswordResetThemeInterface|\ProfilePress\Core\Themes\Shortcode\LoginThemeInterface|\ProfilePress\Core\Themes\Shortcode\RegistrationThemeInterface|\ProfilePress\Core\Themes\Shortcode\MelangeThemeInterface
         */
...
namespace ProfilePress\Core\Integrations\AcademyLMS {
    class Init
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Order\OrderEntity|\ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $order_or_sub
         *
         * @return void
         */
...
namespace ProfilePress\Core\Membership\Controllers {
    ...
    trait CheckoutTrait
    {
        ...
        /**
         * @param int $customer_id
         * @param \ProfilePress\Core\Membership\Models\Order\CartEntity $cart_vars
         *
         * @return int|\WP_Error
         */
    ...
    class CheckoutController extends \ProfilePress\Core\Membership\Controllers\BaseController
    {
         ...
         * @param $vat_number
         * @param \ProfilePress\Core\Membership\Models\Plan\PlanEntity $planObj
         *
    ...
    {
        /**
         * @param int|\ProfilePress\Core\Membership\Models\Plan\PlanEntity $id_or_obj
         */
...
namespace ProfilePress\Core\Membership\Emails {
    ...
    class SubscriptionPaymentFailedNotification extends \ProfilePress\Core\Membership\Emails\AbstractMembershipEmail
    {
...
namespace ProfilePress\Core\Membership\Models\Customer {
    ...
    class CustomerEntity extends \ProfilePress\Core\Membership\Models\AbstractModel implements \ProfilePress\Core\Membership\Models\ModelInterface
    {
         ...
         * @param bool $count
         *
         * @return \ProfilePress\Core\Membership\Models\Order\OrderEntity[]|int
         */
         ...
         * @param bool $count
         *
         * @return \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity[]|int
         */
         ...
         * @param $include_trial
         *
         * @return \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity[]
         */
         ...
         *
         * @return bool|\ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity
         */
...
namespace ProfilePress\Core\Membership\Models\Order {
    ...
    class OrderEntity extends \ProfilePress\Core\Membership\Models\AbstractModel implements \ProfilePress\Core\Membership\Models\ModelInterface
    {
        ...
        /**
         * @return \ProfilePress\Core\Membership\Models\Customer\CustomerEntity
         */
        public function get_customer()
        {
        }
        /**
         * @return \ProfilePress\Core\Membership\Models\Plan\PlanEntity
         */
...
namespace ProfilePress\Core\Membership\Models\Subscription {
    ...
    class SubscriptionEntity extends \ProfilePress\Core\Membership\Models\AbstractModel implements \ProfilePress\Core\Membership\Models\ModelInterface
    {
         ...
         *
         * @return \ProfilePress\Core\Membership\Models\Order\OrderEntity[]|string
         */
        public function get_all_orders()
        {
        }
        /**
         * @return \ProfilePress\Core\Membership\Models\Order\OrderEntity|false
         */
...
namespace ProfilePress\Core\Membership\PaymentMethods\Stripe {
    class APIClass
    {
        ...
        /**
         * @return \ProfilePressVendor\Stripe\StripeClient
         */
    ...
    class Stripe extends \ProfilePress\Core\Membership\PaymentMethods\AbstractPaymentMethod
    {
        ...
        /**
         * @param array $actions
         * @param \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $sub
         * @param \ProfilePress\Core\Membership\PaymentMethods\AbstractPaymentMethod|false $payment_method
         *
         * @return mixed
         */
         ...
         * @param \ProfilePress\Core\Membership\Models\Customer\CustomerEntity $customer
         * @param \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $subscription
         * @param \ProfilePress\Core\Membership\Models\Plan\PlanEntity $plan
         *
         * @return \ProfilePress\Core\Membership\Controllers\CheckoutResponse
         */
...
namespace ProfilePress\Core\Membership\Repositories {
    ...
    class CouponRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Coupon\CouponEntity $data
         *
         * @return false|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param $code
         *
         * @return \ProfilePress\Core\Membership\Models\Coupon\CouponEntity
         */
         ...
         *
         * @return \ProfilePress\Core\Membership\Models\Coupon\CouponEntity[]|array
         */
    ...
    class CustomerRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Customer\CustomerEntity $data
         *
         * @return false|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param $id
         *
         * @return false|\ProfilePress\Core\Membership\Models\Customer\CustomerEntity
         */
        public function retrieve($id)
        {
        }
         ...
         *
         * @return array|\ProfilePress\Core\Membership\Models\Customer\CustomerEntity
         */
         ...
         * @param $count
         *
         * @return \ProfilePress\Core\Membership\Models\Customer\CustomerEntity[]|string
         */
    ...
    class GroupRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Group\GroupEntity $data
         *
         * @return bool|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param $id
         *
         * @return \ProfilePress\Core\Membership\Models\Group\GroupEntity
         */
        public function retrieve($id)
        {
        }
         ...
         * @param bool $count
         *
         * @return \ProfilePress\Core\Membership\Models\Group\GroupEntity[]|array|int
         */
    ...
    class OrderRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Order\OrderEntity $data
         *
         * @return false|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param $id
         *
         * @return \ProfilePress\Core\Membership\Models\Order\OrderEntity
         */
        public function retrieve($id)
        {
        }
         ...
         * @param $count
         *
         * @return int|\ProfilePress\Core\Membership\Models\Order\OrderEntity[]
         */
        public function retrieveBy($args = array(), $count = false)
        {
        }
    ...
    class PlanRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Plan\PlanEntity $data
         *
         * @return false|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param int $current_page
         *
         * @return \ProfilePress\Core\Membership\Models\Plan\PlanEntity[]|array
         */
    ...
    class SubscriptionRepository extends \ProfilePress\Core\Membership\Repositories\BaseRepository
    {
        ...
        /**
         * @param \ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity $data
         *
         * @return false|int
         */
        public function add(\ProfilePress\Core\Membership\Models\ModelInterface $data)
         ...
         * @param $count
         *
         * @return array|\ProfilePress\Core\Membership\Models\Subscription\SubscriptionEntity[]
         */
...
namespace ProfilePress\Core\Membership\Services {
    class Calculator
    {
        /** @var \ProfilePressVendor\Brick\Math\BigDecimal */
        protected $result;
        protected $scale;
        ...
        /**
         * @return \ProfilePressVendor\Brick\Math\BigDecimal
         */
...
namespace ProfilePress\Core\Membership\Services {
    class OrderService
    {
         ...
         * @param $args
         *
         * @return \ProfilePress\Core\Membership\Models\Order\CartEntity
         */
...
namespace ProfilePress\Core\Themes\DragDrop {
    ...
    abstract class AbstractBuildScratch extends \ProfilePress\Core\Themes\DragDrop\AbstractTheme
    {
        ...
        /**
         * @param $field
         * @param \ProfilePress\Core\Admin\SettingsPages\DragDropBuilder\FieldBase $fieldBaseInstance
         *
         * @return mixed
         */
...
namespace {
     ...
     *
     * @return false|\ProfilePress\Core\Membership\PaymentMethods\AbstractPaymentMethod
     */
    ...
    /**
     * @return \ProfilePress\Core\Classes\PPRESS_Session
     */
