    ...
    <div class="glsr-page-header">
        ...
        <div>
            ...
            <div>
                ...
                <?php } ?>
                <a class="components-button has-icon glsr-tooltip" href="<?php echo esc_url(glsr_admin_url('welcome')); ?>" aria-label="<?php echo _x('Open the Getting Started page', 'admin-text', 'site-reviews'); ?>" data-tippy-content="<?php echo _x('Read the Getting Started Guide', 'admin-text', 'site-reviews'); ?>" data-tippy-placement="bottom">
