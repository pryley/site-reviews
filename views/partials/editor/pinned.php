...
<div id="misc-pub-pinned" class="misc-pub-section misc-pub-pinned">
    ...
    <div id="pinned-status-select" class="pinned-status-select hide-if-js">
        ...
        <select id="pinned-status">
            <option value="1"<?php selected($pinned, false); ?>><?= _x('Pin review', 'admin-text', 'site-reviews'); ?></option>
            <option value="0"<?php selected($pinned, true); ?>><?= _x('Unpin review', 'admin-text', 'site-reviews'); ?></option>
        </select>
