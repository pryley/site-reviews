...
<div class="glsr-card postbox is-fullwidth">
    ...
    <div id="welcome-v6_5_0" class="inside">
        ...
        <h4>✨ New Features</h4>
        <ul>
            <li>Added date and status options to the <?php echo glsr_admin_link('tools.general', 'Export Reviews', '#tools-export-reviews'); ?> tool</li>
            <li>Added new <?php echo glsr_admin_link('documentation.shortcodes', '[site_review]', '#shortcode-site_review'); ?> shortcode to display a single review</li>
