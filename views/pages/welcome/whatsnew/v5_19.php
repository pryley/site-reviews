...
<div class="glsr-card postbox is-fullwidth">
    ...
    <div id="welcome-v5_19_0" class="inside">
        <p><em>Release Date &mdash; December 30th, 2021</em></p>

        <h4>✨ New Features</h4>
        <ul>
            <li>Added <code>author_id</code> as an accepted value in the <code>assigned_users</code> shortcode option</li>
            <li>Added <code>author_id</code> column to the <a data-expand="#tools-import-reviews" href="<?php echo glsr_admin_url('tools', 'general'); ?>">Import Third Party Reviews</a> tool</li>
        ...
        <ul>
            ...
            <li>Fixed the <a data-expand="#faq-redirect-after-submission" href="<?php echo glsr_admin_url('documentation', 'faq'); ?>">FAQ documentation</a> for redirects</li>
