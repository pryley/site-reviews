...
<div class="glsr-card postbox is-fullwidth">
    ...
    <div id="welcome-v6_0_0" class="inside">
        ...
        <ul>
            ...
            <li>Added experimental filter hooks to combine css and javascript files when using addons (see <?php echo glsr_admin_link('documentation.hooks', 'Hooks documentation', '#hooks-filter-combine-assets'); ?>)</li>
        ...
        <ul>
            ...
            <li>Changed the minimum required version of PHP to v7.2</li>
            <li>Changed the minimum required version of WordPress to v5.8</li>
            <li>Changed the review title tag from &lt;h3&gt; to &lt;h4&gt;. If you need to change it back, please see the <?php echo glsr_admin_link('documentation.faq', 'FAQ', '#faq-change-review-title-tag'); ?> help page.</h4>
            <li>Changed the strings "← Previous" and "Next →" to "Previous" and "Next". If you have customised these strings in the settings, please <?php echo glsr_admin_link('settings.strings', 'update them'); ?>.</li>
        ...
        <ul>
            ...
            <li>🚨 Removed the <code>site-reviews/after/submission</code> javascript event (if you were using this event, please see the <?php echo glsr_admin_link('welcome.upgrade-guide', 'Upgrade guide', '#upgrade-v6_0_0'); ?>)</li>
        </ul>
        ...
        <ul>
            ...
            <li>Fixed the <?php echo glsr_admin_link('documentation.functions', 'glsr_create_review', '#fn-glsr_create_review'); ?> function to bypass the "Require Approval" setting</li>
