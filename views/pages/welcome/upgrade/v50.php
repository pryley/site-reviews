...
<div class="glsr-card postbox is-fullwidth">
    ...
    return $roundedAverage;
        ...
        <ol>
            <li>
                <p><strong>The <code>glsr_calculate_ratings</code> function has been removed.</strong></p>
            ...
            <li>
                <p><strong>The <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_create_review', '#fn-glsr_create_review'); ?> function arguments have been updated to use the new shortcode options.</strong></p>
            ...
            <li>
                <p><strong>The <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_option', '#fn-glsr_get_option'); ?> function now allows you to automatically cast the returned value to a specific type.</strong></p>
                <p>Please refer to the documentation for more details.</p>
            </li>
            <li>
                <p><strong>The <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_review', '#fn-glsr_get_review'); ?> function now allows you to iterate over custom field data.</strong></p>
...
glsr_debug($review->custom->custom_field_key);
            ...
            <li>
                <p><strong>The <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_reviews', '#fn-glsr_get_reviews'); ?> function arguments have been updated to use the new shortcode options.</strong></p>
                <p>If you are using this function in your PHP code, you should update the key names used in the function argument array. The old key names will continue to work, but this may change in a future version.</p>
            </li>
            <li>
                <p><strong>The <code>glsr_get_rating</code> function has been renamed to <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_ratings', '#fn-glsr_get_ratings'); ?>.</strong></p>
    ...
    'reviews' => '', // this contains the total number of reviews used
        ...
        <p>To access your review data with PHP (including custom field data), use the provided <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_review', '#fn-glsr_get_review'); ?> helper function instead of the <code>get_post_meta</code> function. </p>
    </div>
</div>
