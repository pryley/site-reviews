    ...
    <div id="upgrade-v6_0_0" class="inside">
        ...
        <div class="glsr-notice-inline components-notice is-warning">
            <p class="components-notice__content">
                Site Reviews should automatically migrate itself after updating to v6.0. However, if you are experiencing problems after updating, you may need to manually run the <?php echo glsr_admin_link('tools.general', 'Migrate Plugin', '#tools-migrate-plugin'); ?> tool.
            </p>
        </div>
        ...
        <ol>
            <li>
                ...
                <p>If you want to add the dash back, please see the <?php echo glsr_admin_link('documentation.faq', 'FAQ', '#faq-add-name-dash'); ?> help page.
            </li>
            <li>
                <p><strong>The review title HTML tag has been changed from &lt;h3&gt; to &lt;h4&gt;.</strong></p>
                <p>If you need to change it back to &lt;h3&gt;, please see the <?php echo glsr_admin_link('documentation.faq', 'FAQ', '#faq-change-review-title-tag'); ?> help page.</p>
            </li>
            <li>
        ...
        <ol>
            <li>
                ...
                <p>If you have customised these strings in the settings, please <?php echo glsr_admin_link('settings.strings', 'update them'); ?>.</p>
            </li>
        </ol>
