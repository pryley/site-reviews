...
<div class="is-fullwidth">
    <div class="glsr-flex-row glsr-has-2-columns">
        ...
        <div class="glsr-column">
            ...
            <a class="button" href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!shortcodes'); ?>">View Shortcode Documentation</a>
        </div>
    </div>
</div>
<hr>
<div class="is-fullwidth">
    ...
    <ul class="glsr-flex-row glsr-has-3-columns">
        ...
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!reviews'); ?>">Avatars</a></h3>
            <p>Enable avatars to generate images using the WordPress Gravatar service.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=tools#!general'); ?>">Backup/Restore</a></h3>
            <p>Backup and restore your plugin settings as needed.</p>
        </li>
        <li class="glsr-column">
            <h3><a data-expand="#faq-14" href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!faq'); ?>">Bayesian Ranking</a></h3>
            <p>Easily rank pages with assigned reviews using the bayesian algorithm.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!submissions'); ?>">Blacklist</a></h3>
        ...
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!faq'); ?>">Documentation</a></h3>
        ...
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!schema'); ?>">JSON-LD Schema</a></h3>
            <p>Enable JSON-LD schema to display your reviews and ratings in search results.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!general'); ?>">Multilingual</a></h3>
        ...
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!general'); ?>">Notifications</a></h3>
            <p>Send notifications to one or more emails when a review is submitted.</p>
        </li>
        <li class="glsr-column">
            <h3><a data-expand="#faq-03" href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!faq'); ?>">Page Assignment</a></h3>
            <p>Assign reviews to Posts, Pages, and Custom Post Types.</p>
        </li>
        <li class="glsr-column">
            <h3><a data-expand="#faq-02" href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!faq'); ?>">Pagination</a></h3>
        ...
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!general'); ?>">Restrictions</a></h3>
            <p>Require approval before publishing reviews and limit to registered users.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!submissions'); ?>">Review Limits</a></h3>
            <p>Limit review submissions by email address, IP address, or username.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!shortcodes'); ?>">Review Summaries</a></h3>
            <p>Display a summary of your review ratings from high to low.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=documentation#!shortcodes'); ?>">Shortcodes</a></h3>
            <p>Use the configurable shortcodes complete with documentation.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!general'); ?>">Slack</a></h3>
            <p>Receive notifications in Slack when a review is submitted.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!submissions'); ?>">SPAM Protection</a></h3>
            <p>Uses a Honeypot and integrates with Invisible reCAPTCHA and Akismet.</p>
        </li>
        <li class="glsr-column">
            <h3><a href="<?= admin_url('edit.php?post_type='.glsr()->post_type.'&page=settings#!general'); ?>">Styles</a></h3>
