...
<div class="is-fullwidth">
    <div class="glsr-flex-row glsr-has-2-columns">
        ...
        <div class="glsr-column">
            ...
            <a target="_blank" class="button" href="<?= admin_url('edit.php?post_type=site-review&page=documentation#!shortcodes'); ?>">View Shortcode Documentation</a>
        </div>
    </div>
</div>
<hr>
<div class="is-fullwidth">
    ...
    <ul class="glsr-flex-row glsr-has-3-columns">
        ...
        <li class="glsr-column">
            ...
            <p>Designed for WordPress developers with over 100 filter hooks.</p>
        </li>
        <li class="glsr-column">
            <h3>Documentation</h3>
