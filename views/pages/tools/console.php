...
<form method="post" class="glsr-float-left">
    ...
    <?php submit_button(esc_att_x('Download Console', 'admin-text', 'site-reviews'), 'primary', '', false); ?>
</form>
<form method="post" class="glsr-float-left">
    ...
    <button type="submit" class="glsr-button button" id="fetch-console">
        <span data-loading="<?= esc_att_x('Reloading...', 'admin-text', 'site-reviews'); ?>"><?= _x('Reload', 'admin-text', 'site-reviews'); ?></span>
    </button>
</form>
<form method="post">
    ...
    <button type="submit" class="glsr-button button" id="clear-console">
        <span data-loading="<?= esc_att_x('Clearing...', 'admin-text', 'site-reviews'); ?>"><?= _x('Clear', 'admin-text', 'site-reviews'); ?></span>
    </button>
</form>
