...
<div class="glsr-card postbox">
    <h3 class="glsr-card-heading">
        <button type="button" class="glsr-accordion-trigger" aria-expanded="false" aria-controls="tools-optimise-db-tables">
            <span class="title dashicons-before dashicons-admin-tools"><?php echo _x('Optimise Your Database Tables', 'admin-text', 'site-reviews'); ?></span>
    ...
    <div id="tools-optimise-db-tables" class="inside">
        <?php if (!empty($myisam_tables)) { ?>
            ...
            <table class="wp-list-table widefat striped" style="margin-bottom:1em;">
                <thead>
                    <tr>
                        <th scope="col"><strong><?php echo _x('Table', 'admin-text', 'site-reviews'); ?></strong></th>
                        <th scope="col"><strong><?php echo _x('Engine', 'admin-text', 'site-reviews'); ?></strong></th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-ajax-hide>
                        <td style="vertical-align:middle;"><?php echo $table; ?></td>
                        ...
                        <td style="text-align:right;">
                            <form method="post">
                                ...
                                <button type="submit" class="glsr-button button button-small"
                                    data-ajax-click
