...
include trailingslashit(__DIR__).'faq/change-form-field-order.php';
include trailingslashit(__DIR__).'faq/change-pagination-query.php';
include trailingslashit(__DIR__).'faq/translate-text.php';
include trailingslashit(__DIR__).'faq/create-review.php';
include trailingslashit(__DIR__).'faq/customise-stars.php';
