<div class="glsr-card postbox">
    ...
    <div id="shortcode-site_reviews_form" class="inside">
        ...
        <p>Include the "assigned_posts" option to automatically assign submitted reviews to specific posts, pages, or other public post types. Accepted values are a <a href="https://wpklik.com/wordpress-tutorials/how-to-quickly-find-your-wordpress-page-and-post-id/">WordPress Post ID</a>, <code>post_id</code> which automatically uses the Post ID of the current page, or <code>parent_id</code> which automatically uses the Post ID of the parent page. Separate multiple values with a comma.</p>
