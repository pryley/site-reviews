<div class="glsr-card postbox">
    ...
    <div id="shortcode-site_reviews_summary" class="inside">
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary assigned_posts=<span class="attr-value">"post_id"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary assigned_terms=<span class="attr-value">"13,14"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary assigned_users=<span class="attr-value">"1,2"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary class=<span class="attr-value">"my-reviews-summary full-width"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary hide=<span class="attr-value">"bars,if_empty,rating,stars,summary"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary id=<span class="attr-value">"type-some-random-text-here"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary labels=<span class="attr-value">"5 star,4 star,3 star,2 star,1 star"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary rating=<span class="attr-value">"3"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary schema=<span class="attr-value">"true"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews_summary text=<span class="attr-value">"{num} customer reviews"</span>]</code></pre>
    </div>
</div>
