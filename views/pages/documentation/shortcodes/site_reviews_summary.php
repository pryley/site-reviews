<div class="glsr-card postbox">
    ...
    <div id="shortcode-site_reviews_summary" class="inside">
        ...
        <pre><code class="language-html">[site_reviews_summary assigned_posts="post_id"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary assigned_terms="13,14"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary assigned_users="1,2"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary class="my-reviews-summary full-width"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary hide="bars,if_empty,rating,stars,summary"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary id="type-some-random-text-here"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary labels="5 star,4 star,3 star,2 star,1 star"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary rating="3"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary schema="true"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews_summary text="{num} customer reviews"]</code></pre>
    </div>
</div>
