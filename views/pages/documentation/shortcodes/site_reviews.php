<div class="glsr-card postbox">
    ...
    <div id="shortcode-site_reviews" class="inside">
        ...
        <pre><code class="syntax-shortcode">[site_reviews assigned_posts=<span class="attr-value">"post_id"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews assigned_terms=<span class="attr-value">"13,14"]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews assigned_users=<span class="attr-value">"1,2"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews class=<span class="attr-value">"my-reviews full-width"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews display=<span class="attr-value">"20"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews fallback=<span class="attr-value">"No reviews found."</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews hide=<span class="attr-value">"assigned_links,author,avatar,content,date,rating,response,title"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews id=<span class="attr-value">"type-some-random-text-here"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews offset=<span class="attr-value">"1"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews pagination=<span class="attr-value">"ajax"</span>]</code></pre>
        ...
        <pre><code class="syntax-shortcode">[site_reviews rating=<span class="attr-value">"4"</span>]</code></pre>
        ...
        <p><span class="required">Important:</span> This option should only be used once on a page to avoid duplicate schemas; keep that in mind if you are using more than one [site_reviews] and/or [site_reviews_summary] shortcodes on the same page.</p>
        <p>The default schema value is: <code>"false"</code></p>
        <pre><code class="syntax-shortcode">[site_reviews schema=<span class="attr-value">"true"</span>]</code></pre>
    </div>
</div>
