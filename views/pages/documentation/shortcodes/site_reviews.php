<div class="glsr-card postbox">
    ...
    <div id="shortcode-site_reviews" class="inside">
        ...
        <pre><code class="language-html">[site_reviews assigned_posts="post_id"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews assigned_terms="13,14"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews assigned_users="1,2"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews class="my-reviews full-width"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews display="20"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews fallback="No reviews found."]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews id="type-some-random-text-here"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews offset="1"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews pagination="ajax"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews rating="4"]</code></pre>
        ...
        <pre><code class="language-html">[site_reviews schema="true"]</code></pre>
    </div>
</div>
