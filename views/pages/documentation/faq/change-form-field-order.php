...
<div class="glsr-card postbox">
    ...
    <div id="faq-change-form-field-order" class="inside">
        <p>To customise the order of the fields in the review form, use the <code><a data-expand="#hooks-filter-form-field-order" href="<?= glsr_admin_url('documentation', 'hooks'); ?>">site-reviews/review-form/order</a></code> filter hook in your child theme's <code>functions.php</code> file.</p>
