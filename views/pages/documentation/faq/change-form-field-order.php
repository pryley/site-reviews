...
<div class="glsr-card postbox">
    ...
    <div id="faq-change-form-field-order" class="inside">
        <p>To customise the order of the fields in the review form, use the <code><?php echo glsr_admin_link(['documentation', 'hooks'], 'site-reviews/review-form/order', '#hooks-filter-form-field-order'); ?></code> filter hook in your child theme's <code>functions.php</code> file.</p>
...
add_filter('site-reviews/review-form/order', function ($order) {
    ...
    return [
        ...
        <p>If you have used the example above and the review-form fields are not working correctly, check the <code><?php echo glsr_admin_link(['tools', 'console']); ?></code> for errors.</p>
    </div>
</div>
