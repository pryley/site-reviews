...
if ($review) {
    glsr_debug($review);
                ...
                <p>To learn more about the <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_get_review', '#fn-glsr_get_review'); ?> function, please refer to the Functions documentation page.</p>
            </li>
        </ol>
    </div>
</div>
