...
<div class="glsr-card postbox">
    ...
    <div id="faq-ipaddress-incorrectly-detected" class="inside">
        ...
        <p>Once you know the custom HTTP request header to use, you may add it with the following code snippet and then test it using the <a href="<?php echo glsr_admin_url('tools', 'general'); ?>" data-expand="#tools-ip-detection"><code>Test IP Address Detection</code></a> tool.</p>
