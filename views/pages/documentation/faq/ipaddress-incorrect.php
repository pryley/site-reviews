...
<div class="glsr-card postbox">
    <h3 class="glsr-card-heading">
        <button type="button" class="glsr-accordion-trigger" aria-expanded="false" aria-controls="faq-ipaddress-incorrect">
            <span class="title">Why is the IP address incorrectly detected?</span>
    ...
    <div id="faq-ipaddress-incorrect" class="inside">
        ...
        <p>Once you know the custom HTTP request header to use, you may add it with the following code snippet and then test it using the <a href="<?php echo glsr_admin_url('tools', 'general'); ?>" data-expand="#tools-ip-detection"><code>Configure IP Address Detection</code></a> tool.</p>
