...
<div class="glsr-card postbox">
    ...
    <div id="faq-notify-author-when-responding" class="inside">
        <p>This code snippet will send an email notification to the review author after you respond to their review. Alternatively, you can use the <?php echo glsr_premium_link('site-reviews-notifications'); ?> addon.</p>
