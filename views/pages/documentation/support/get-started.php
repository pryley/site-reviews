<div class="glsr-card postbox open">
    ...
    <div id="support-get-started" class="inside">
        <div class="glsr-youtube">
            <button class='glsr-youtube-button' data-id="PLn-nTn-jOuWnsMviIHjIMRIitM47aAanA" aria-label="Play">
            ...
            <span class="glsr-youtube-overlay">
                <svg viewBox="0 0 500 200" preserveAspectRatio="none">
                    ...
                    <mask id="glsr-svg-overlay-mask">
                        <rect x="0" y="0" width="500" height="200" fill="url(#glsr-svg-overlay-radial-gradient)"></rect>
                    </mask>
