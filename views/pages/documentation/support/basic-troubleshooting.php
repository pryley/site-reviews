...
<div class="glsr-card postbox">
    ...
    <div id="support-basic-troubleshooting" class="inside">
        ...
        <p>If you recently upgraded to a new version of Site Reviews and your reviews stopped working, try running the <?php echo glsr_admin_link(['tools', 'general'], 'Migrate Plugin (Hard Reset)', '#tools-migrate-plugin'); ?> and <?php echo glsr_admin_link(['tools', 'general'], 'Reset Assigned Meta Values', '#tools-reset-assigned-meta'); ?> tools. Plugin migrations should run automatically in the background when needed; however, sometimes, you may need to run these tools manually.</p>
