...
<div class="glsr-card postbox">
    ...
    <div id="support-common-problems-and-solutions" class="inside">
        ...
        <p>If there are no <em>pending</em> actions in the Action Scheduler, please verify that you are sending from an email address that uses the same domain as your website. For example, if your website is <code>https://reviews.com</code>, the email address you are sending from should end with <code>@reviews.com</code>. You can change the email address from which notifications are sent in the <code><a href="<?= glsr_admin_url('settings', 'general'); ?>">plugin settings</a></code>. Alternatively, use the <a href="https://wordpress.org/plugins/wp-mail-smtp/" target="_blank">WP Mail SMTP</a> plugin to reconfigure WordPress to use a SMTP provider (see also: <a href="https://www.butlerblog.com/2013/12/12/easy-smtp-email-wordpress-wp_mail/" target="_blank">Easy SMTP email settings for WordPress</a>).</p>
        <p>Finally, use the <a href="https://wordpress.org/plugins/check-email/" target="_blank">Check & Log Email</a> plugin to verify that your website can sucessfully send emails.</p>
