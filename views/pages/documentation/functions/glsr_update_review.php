...
<div class="glsr-card postbox">
    ...
    <div id="fn-glsr_update_review" class="inside">
        <div class="glsr-notice-inline components-notice is-warning">
            <p class="components-notice__content">This function uses basic validation on the provided values. If validation fails, the function will return false and the validation errors will be logged to the <code><?php echo glsr_admin_link(['tools', 'console']); ?></code>.</p>
        </div>
...
$review = apply_filters('glsr_update_review', false, 13, [
    ...
    'xyz' => 'This is a custom field!'
        ...
        <p>You can use the <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_debug', '#fn-glsr_debug'); ?> helper function to view the review object that is returned.</p>
