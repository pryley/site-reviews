...
$requireApproval = apply_filters('glsr_get_option', false, 'general.require.approval', 'no', 'bool');</code></pre>
        ...
        <p>You can use the <?php echo glsr_admin_link(['documentation', 'functions'], 'glsr_debug', '#fn-glsr_debug'); ?> helper function to view the whole plugin settings array, this will help you figure out which dot-notation path to use.</p>
