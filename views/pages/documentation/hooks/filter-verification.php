...
<div class="glsr-card postbox">
    ...
    <div id="hooks-manual-verification" class="inside">
        <div class="glsr-notice-inline components-notice is-warning">
            <p class="components-notice__content">The recommended method for verifying reviews is to enable the <code><?php echo glsr_admin_link(['settings', 'general'], 'Request Verification'); ?></code> setting which automatically sends an email to reviewers asking them to verify their review.</p>
        </div>
