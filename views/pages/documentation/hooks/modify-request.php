...
<div class="glsr-card postbox">
    ...
    <div id="hooks-modify-review-request" class="inside">
        <p>Use this hook if you want to modify the request of a submitted review. This hook is similar to the <code><a data-expand="#hooks-filter-submitted-review-values" href="<?php echo glsr_admin_url('documentation', 'hooks'); ?>">site-reviews/create/review-values</a></code> hook, except that it allows you to directly modify the raw Request object before the values are sanitized.</p>
