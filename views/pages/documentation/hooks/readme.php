<div class="glsr-card postbox">
    ...
    <div id="fn-readme" class="inside">
        <p>Hooks (also known as <a href="https://developer.wordpress.org/plugins/hooks/index.html">Actions and Filters</a>) are used to make changes to the plugin without directly editing the plugin.</p>
        ...
        <ol>
            ...
            <li>Use them in the <span class="code">functions.php</span> file of a Child Theme.</li>
        </ol>
