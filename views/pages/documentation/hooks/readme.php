...
<div class="glsr-card postbox">
    ...
    <div id="fn-readme" class="inside">
        ...
        <p>To generate a child theme for your theme, you can either follow the directions in the <a href="https://developer.wordpress.org/themes/advanced-topics/child-themes/" target="_blank">WordPress handbook</a>, or use a child theme generator plugin such as <a href="<?= admin_url('plugin-install.php?s=essentialthemes&tab=search&type=author'); ?>">Child Theme X</a>.</p>
    </div>
</div>
