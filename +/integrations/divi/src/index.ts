...
import { SiteReview } from '@site-reviews-divi/modules/site_review';
import { SiteReviews } from '@site-reviews-divi/modules/site_reviews';
import { SiteReviewsForm } from '@site-reviews-divi/modules/site_reviews_form';
import { SiteReviewsSummary } from '@site-reviews-divi/modules/site_reviews_summary';
import {
  iconForm,
  iconLogo,
  iconReview,
