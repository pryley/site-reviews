...
const Serializer = function (form) {
    this.data = {};
...
Serializer.prototype = {
    ...
    addPair: function (pair) {
        ...
        this.data = jQuery.extend(true, this.data, this.makeObject(pair.name, this.encode(pair)));
    },
    ...
    encode: function (pair) {
        switch(jQuery('[name="'+pair.name+'"]', this.form).attr('type')) {
            case 'checkbox':
