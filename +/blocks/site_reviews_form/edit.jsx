...
import { AjaxFormTokenField, AjaxToggleGroupControl, ColorControl, resolveColor } from '@site-reviews/components';
...
const Edit = (props) => {
    ...
    return (
        <ServerSideBlockRenderer
            ...
            props={props}
            style={{
                '--glsr-form-star-bg': resolveColor(style_rating_color, style_rating_color_custom),
            }}
            styleClassNames={[
