...
class Reader extends AbstractCsv implements TabularDataReader, JsonSerializable
{
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Reader::nth() instead', since:'league/csv:9.9.0')]
     ...
     * @throws TypeCastingFailed
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Reader::getRecordsAsObject() instead', since:'league/csv:9.15.0')]
