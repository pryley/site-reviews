...
use GeminiLabs\League\Csv\Serializer\Denormalizer;
use GeminiLabs\League\Csv\Serializer\MappingFailed;
use GeminiLabs\League\Csv\Serializer\TypeCastingFailed;
use LimitIterator;
use mysqli_result;
use PDOStatement;
use PgSql\Result;
...
class ResultSet implements TabularDataReader, JsonSerializable
{
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Resultset::fetchColumn() instead', since:'league/csv:9.23.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Resultset::nth() instead', since:'league/csv:9.9.0')]
     ...
     * @throws TypeCastingFailed
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\ResultSet::getRecordsAsObject() instead', since:'league/csv:9.15.0')]
     ...
     * @throws SyntaxError
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\ResultSet::from() instead', since:'league/csv:9.22.0')]
