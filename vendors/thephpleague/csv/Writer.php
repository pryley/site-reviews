...
class Writer extends AbstractCsv implements TabularDataWriter
{
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Writer::getEndOfLine()', since:'league/csv:9.10.0')]
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Writer::setEndOfLine()', since:'league/csv:9.10.0')]
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Writer::necessaryEnclosure()', since:'league/csv:9.22.0')]
