...
class CharsetConverter extends php_user_filter
{
     ...
     * @return resource
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\CharserConverter::appendOnReadTo() or League\Csv\CharserConverter::appendOnWriteTo() instead', since:'league/csv:9.22.0')]
     ...
     * @return resource
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\CharserConverter::prependOnReadTo() or League\Csv\CharserConverter::prependOnWriteTo() instead', since:'league/csv:9.22.0')]
