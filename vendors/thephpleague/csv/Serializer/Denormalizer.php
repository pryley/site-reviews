...
namespace GeminiLabs\League\Csv\Serializer;

use Closure;
use Deprecated;
use Iterator;
use GeminiLabs\League\Csv\MapIterator;
...
final class Denormalizer
{
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\Serializer\MapRecord::$convertEmptyStringToNull or League\Csv\Serializer\MapCell::$convertEmptyStringToNullinstead', since:'league/csv:9.17.0')]
