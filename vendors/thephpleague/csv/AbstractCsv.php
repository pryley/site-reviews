...
abstract class AbstractCsv implements ByteSequence
{
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::supportsStreamFilterOnRead() or League\Csv\AbstractCsv::supportsStreamFilterOnWrite() instead', since:'league/csv:9.7.0')]
     ...
     * @codeCoverageIgnore
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::toString() instead', since:'league/csv:9.7.0')]
     ...
     * Retrieves the CSV content
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::toString() instead', since:'league/csv:9.1.0')]
     ...
     */
    #[Deprecated(message:'the method no longer affect the outcome of the class, use GeminiLabs\League\Csv\HttpHeaders::forFileDownload instead', since:'league/csv:9.17.0')]
     ...
     * @throws Exception
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::download() instead', since:'league/csv:9.18.0')]
     ...
     * @throws UnavailableFeature If the stream filter API can not be used
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::appendStreamFilterOnRead() or League\Csv\AbstractCsv::prependStreamFilterOnRead() instead', since:'league/csv:9.18.0')]
     ...
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::from() instead', since:'league/csv:9.27.0')]
     ...
     * Returns a new instance from a string.
     */
    #[Deprecated(message:'use GeminiLabs\League\Csv\AbstractCsv::fromString() instead', since:'league/csv:9.27.0')]
