...
return [
	...
	'settings.general.notification_message' => [
		...
		'depends' => ['notification' => ['custom', 'default', 'webhook']],
		'desc' => __(
	...
	'settings.reviews.date.custom' => [
		...
		'depends' => ['date.format' => 'custom'],
		'desc' => __( 'Enter a custom date format (<a href="https://codex.wordpress.org/Formatting_Date_and_Time">documentation on date and time formatting</a>).', 'site-reviews' ),
	...
	'settings.submissions.akismet' => [
		'default' => false,
		'desc' => __( 'the <a href="https://akismet.com" target="_blank">Akismet plugin</a> integration provides spam-filtering for your reviews. In order for this setting to have any affect, you will need to first install and activate the Akismet plugin and set up a WordPress.com API key.', 'site-reviews' ),
		'label' => __( 'Enable Akismet Integration', 'site-reviews' ),
		'type' => 'yesno_inline',
	],
	'settings.submissions.recaptcha.integration' => [
		'default' => '',
		'desc' => __( 'Invisible reCAPTCHA is a free anti-spam service from Google. To use it, you will need to <a href="https://www.google.com/recaptcha/admin" target="_blank">sign up</a> for an API key pair for your site. If you are already using a reCAPTCHA plugin listed here, please select it; otherwise choose "Use reCAPTCHA".', 'site-reviews' ),
	...
	'settings.submissions.recaptcha.key' => [
		'default' => '',
		'depends' => ['recaptcha.integration' => 'custom'],
