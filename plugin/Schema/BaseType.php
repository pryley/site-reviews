...
use GeminiLabs\SiteReviews\Schema\Exceptions\InvalidProperty;
use GeminiLabs\SiteReviews\Schema\Type;
...
abstract class BaseType implements ArrayAccess, JsonSerializable, Type
{
	...
	public function setProperty( $property, $value )
	{
		if( !in_array( $property, $this->allowed )
			...
			glsr_log( $this->getType().' does not allow the "'.$property.'" property', 'warning' );
			return $this;
		}
	...
	protected function getParents( $parents = null )
	{
		...
		foreach( $parents as $parent ) {
			$parentClass = glsr_resolve( 'Helper' )->buildClassName( $parent, __NAMESPACE__ );
	...
	protected function serializeProperty( $property )
	{
		...
		if( $property instanceof DateTimeInterface || $property instanceof DateTime ) {
