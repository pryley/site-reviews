...
class SiteReviewsButton extends ButtonGenerator
{
	...
	public function fields()
	{
		return [[
			...
			'name' => 'rating',
			'options' => [
				'5' => sprintf( esc_html_x( '%s star', '%s stars', 5, 'site-reviews' ), 5 ),
				'4' => sprintf( esc_html_x( '%s star', '%s stars', 4, 'site-reviews' ), 4 ),
				'3' => sprintf( esc_html_x( '%s star', '%s stars', 3, 'site-reviews' ), 3 ),
