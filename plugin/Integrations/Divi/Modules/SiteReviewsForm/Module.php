...
class Module implements DependencyInterface
{
    public function load(): void
    {
        add_action('init', function () {
            $modulePath = glsr()->path('assets/divi/modules-json/site_reviews_form/');
    ...
    {
        return \WP_Block_Type_Registry::get_instance()->get_registered('glsr-divi/form')->customCssFields;
    }
