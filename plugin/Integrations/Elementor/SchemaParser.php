...
class SchemaParser extends Parser
{
    public function generate(): array
    {
        if (!class_exists('Elementor\Plugin') 
            || !\Elementor\Plugin::$instance->documents->get(get_the_ID())->is_built_with_elementor()) { // @phpstan-ignore-line
            return [];
        }
        $widgets = Cast::toString(get_post_meta(get_the_ID(), '_elementor_data', true));
